	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li style="margin: 5px;" class=""><a
				...
				style="font-size: 18px; font-family: Amiri, sans-serif; padding: 5px; width: 130px"
				href="client-balance">الميـزان (ع)<img
					style="margin-right: 5px; width: 35px; display: inline"
			...
			<li style="margin: 5px;" class=""><a
				class="btn bg-success text-white font-weight-bold"
				style="font-size: 18px; font-family: Amiri, sans-serif; padding: 5px; width: 110px"
			...
			<li style="margin: 5px;" class=""><a
				class="btn bg-success text-white font-weight-bold"
				style="font-size: 18px; font-family: Amiri, sans-serif; padding: 5px; width: 110px"
				href="clients">العمــلاء <img
					style="margin-right: 5px; width: 35px; display: inline"
					src="icons/customer.png"></a></li>


			<li style="margin: 5px;" class=""><a
				class="btn bg-success text-white font-weight-bold"
				style="font-size: 18px; font-family: Amiri, sans-serif; padding: 5px; width: 115px"
				href="sellers">البائعــون <img
					style="margin-right: 5px; width: 35px; display: inline"
